...
ParticleParams gLawnParticleArray[(int)ParticleEffect::NUM_PARTICLES] = {
	{ParticleEffect::PARTICLE_MELONSPLASH, {"PVZ", "particles/MelonImpact.xml"}},
	{ParticleEffect::PARTICLE_WINTERMELON, {"PVZ", "particles/WinterMelonImpact.xml"}},
	{ParticleEffect::PARTICLE_FUMECLOUD, {"PVZ", "particles/FumeCloud.xml"}},
	{ParticleEffect::PARTICLE_POPCORNSPLASH, {"PVZ", "particles/PopcornSplash.xml"}},
	{ParticleEffect::PARTICLE_POWIE, {"PVZ", "particles/Powie.xml"}},
	{ParticleEffect::PARTICLE_JACKEXPLODE, {"PVZ", "particles/JackExplode.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_HEAD, {"PVZ", "particles/ZombieHead.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_ARM, {"PVZ", "particles/ZombieArm.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_TRAFFIC_CONE, {"PVZ", "particles/ZombieTrafficCone.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_PAIL, {"PVZ", "particles/ZombiePail.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_HELMET, {"PVZ", "particles/ZombieHelmet.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_FLAG, {"PVZ", "particles/ZombieFlag.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_DOOR, {"PVZ", "particles/ZombieDoor.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_NEWSPAPER, {"PVZ", "particles/ZombieNewspaper.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_HEADLIGHT, {"PVZ", "particles/ZombieHeadLight.xml"}},
	{ParticleEffect::PARTICLE_POW, {"PVZ", "particles/Pow.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_POGO, {"PVZ", "particles/ZombiePogo.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_NEWSPAPER_HEAD, {"PVZ", "particles/ZombieNewspaperHead.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_BALLOON_HEAD, {"PVZ", "particles/ZombieBalloonHead.xml"}},
	{ParticleEffect::PARTICLE_SOD_ROLL, {"PVZ", "particles/SodRoll.xml"}},
	{ParticleEffect::PARTICLE_GRAVE_STONE_RISE, {"PVZ", "particles/GraveStoneRise.xml"}},
	{ParticleEffect::PARTICLE_PLANTING, {"PVZ", "particles/Planting.xml"}},
	{ParticleEffect::PARTICLE_PLANTING_POOL, {"PVZ", "particles/PlantingPool.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_RISE, {"PVZ", "particles/ZombieRise.xml"}},
	{ParticleEffect::PARTICLE_GRAVE_BUSTER, {"PVZ", "particles/GraveBuster.xml"}},
	{ParticleEffect::PARTICLE_GRAVE_BUSTER_DIE, {"PVZ", "particles/GraveBusterDie.xml"}},
	{ParticleEffect::PARTICLE_POOL_SPLASH, {"PVZ", "particles/PoolSplash.xml"}},
	{ParticleEffect::PARTICLE_ICE_SPARKLE, {"PVZ", "particles/IceSparkle.xml"}},
	{ParticleEffect::PARTICLE_SEED_PACKET, {"PVZ", "particles/SeedPacket.xml"}},
	{ParticleEffect::PARTICLE_TALL_NUT_BLOCK, {"PVZ", "particles/TallNutBlock.xml"}},
	{ParticleEffect::PARTICLE_DOOM, {"PVZ", "particles/Doom.xml"}},
	{ParticleEffect::PARTICLE_DIGGER_RISE, {"PVZ", "particles/DiggerRise.xml"}},
	{ParticleEffect::PARTICLE_DIGGER_TUNNEL, {"PVZ", "particles/DiggerTunnel.xml"}},
	{ParticleEffect::PARTICLE_DANCER_RISE, {"PVZ", "particles/DancerRise.xml"}},
	{ParticleEffect::PARTICLE_POOL_SPARKLY, {"PVZ", "particles/PoolSparkly.xml"}},
	{ParticleEffect::PARTICLE_WALLNUT_EAT_SMALL, {"PVZ", "particles/WallnutEatSmall.xml"}},
	{ParticleEffect::PARTICLE_WALLNUT_EAT_LARGE, {"PVZ", "particles/WallnutEatLarge.xml"}},
	{ParticleEffect::PARTICLE_PEA_SPLAT, {"PVZ", "particles/PeaSplat.xml"}},
	{ParticleEffect::PARTICLE_BUTTER_SPLAT, {"PVZ", "particles/ButterSplat.xml"}},
	{ParticleEffect::PARTICLE_CABBAGE_SPLAT, {"PVZ", "particles/CabbageSplat.xml"}},
	{ParticleEffect::PARTICLE_PUFF_SPLAT, {"PVZ", "particles/PuffSplat.xml"}},
	{ParticleEffect::PARTICLE_STAR_SPLAT, {"PVZ", "particles/StarSplat.xml"}},
	{ParticleEffect::PARTICLE_ICE_TRAP, {"PVZ", "particles/IceTrap.xml"}},
	{ParticleEffect::PARTICLE_SNOWPEA_SPLAT, {"PVZ", "particles/SnowPeaSplat.xml"}},
	{ParticleEffect::PARTICLE_SNOWPEA_PUFF, {"PVZ", "particles/SnowPeaPuff.xml"}},
	{ParticleEffect::PARTICLE_SNOWPEA_TRAIL, {"PVZ", "particles/SnowPeaTrail.xml"}},
	{ParticleEffect::PARTICLE_LANTERN_SHINE, {"PVZ", "particles/LanternShine.xml"}},
	{ParticleEffect::PARTICLE_SEED_PACKET_PICKUP, {"PVZ", "particles/Award.xml"}},
	{ParticleEffect::PARTICLE_POTATO_MINE, {"PVZ", "particles/PotatoMine.xml"}},
	{ParticleEffect::PARTICLE_POTATO_MINE_RISE, {"PVZ", "particles/PotatoMineRise.xml"}},
	{ParticleEffect::PARTICLE_PUFFSHROOM_TRAIL, {"PVZ", "particles/PuffShroomTrail.xml"}},
	{ParticleEffect::PARTICLE_PUFFSHROOM_MUZZLE, {"PVZ", "particles/PuffShroomMuzzle.xml"}},
	{ParticleEffect::PARTICLE_SEED_PACKET_FLASH, {"PVZ", "particles/SeedPacketFlash.xml"}},
	{ParticleEffect::PARTICLE_WHACK_A_ZOMBIE_RISE, {"PVZ", "particles/WhackAZombieRise.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_LADDER, {"PVZ", "particles/ZombieLadder.xml"}},
	{ParticleEffect::PARTICLE_UMBRELLA_REFLECT, {"PVZ", "particles/UmbrellaReflect.xml"}},
	{ParticleEffect::PARTICLE_SEED_PACKET_PICK, {"PVZ", "particles/SeedPacketPick.xml"}},
	{ParticleEffect::PARTICLE_ICE_TRAP_ZOMBIE, {"PVZ", "particles/IceTrapZombie.xml"}},
	{ParticleEffect::PARTICLE_ICE_TRAP_RELEASE, {"PVZ", "particles/IceTrapRelease.xml"}},
	{ParticleEffect::PARTICLE_ZAMBONI_SMOKE, {"PVZ", "particles/ZamboniSmoke.xml"}},
	{ParticleEffect::PARTICLE_GLOOMCLOUD, {"PVZ", "particles/GloomCloud.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_POGO_HEAD, {"PVZ", "particles/ZombiePogoHead.xml"}},
	{ParticleEffect::PARTICLE_ZAMBONI_TIRE, {"PVZ", "particles/ZamboniTire.xml"}},
	{ParticleEffect::PARTICLE_ZAMBONI_EXPLOSION, {"PVZ", "particles/ZamboniExplosion.xml"}},
	{ParticleEffect::PARTICLE_ZAMBONI_EXPLOSION2, {"PVZ", "particles/ZamboniExplosion2.xml"}},
	{ParticleEffect::PARTICLE_CATAPULT_EXPLOSION, {"PVZ", "particles/CatapultExplosion.xml"}},
	{ParticleEffect::PARTICLE_MOWER_CLOUD, {"PVZ", "particles/MowerCloud.xml"}},
	{ParticleEffect::PARTICLE_BOSS_ICE_BALL, {"PVZ", "particles/BossIceBallTrail.xml"}},
	{ParticleEffect::PARTICLE_BLASTMARK, {"PVZ", "particles/BlastMark.xml"}},
	{ParticleEffect::PARTICLE_COIN_PICKUP_ARROW, {"PVZ", "particles/CoinPickupArrow.xml"}},
	{ParticleEffect::PARTICLE_PRESENT_PICKUP, {"PVZ", "particles/PresentPickup.xml"}},
	{ParticleEffect::PARTICLE_IMITATER_MORPH, {"PVZ", "particles/ImitaterMorph.xml"}},
	{ParticleEffect::PARTICLE_MOWERED_ZOMBIE_HEAD, {"PVZ", "particles/MoweredZombieHead.xml"}},
	{ParticleEffect::PARTICLE_MOWERED_ZOMBIE_ARM, {"PVZ", "particles/MoweredZombieArm.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_HEAD_POOL, {"PVZ", "particles/ZombieHeadPool.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_BOSS_FIREBALL, {"PVZ", "particles/Zombie_boss_fireball.xml"}},
	{ParticleEffect::PARTICLE_FIREBALL_DEATH, {"PVZ", "particles/FireballDeath.xml"}},
	{ParticleEffect::PARTICLE_ICEBALL_DEATH, {"PVZ", "particles/IceballDeath.xml"}},
	{ParticleEffect::PARTICLE_ICEBALL_TRAIL, {"PVZ", "particles/Iceball_Trail.xml"}},
	{ParticleEffect::PARTICLE_FIREBALL_TRAIL, {"PVZ", "particles/Fireball_Trail.xml"}},
	{ParticleEffect::PARTICLE_BOSS_EXPLOSION, {"PVZ", "particles/BossExplosion.xml"}},
	{ParticleEffect::PARTICLE_SCREEN_FLASH, {"PVZ", "particles/ScreenFlash.xml"}},
	{ParticleEffect::PARTICLE_TROPHY_SPARKLE, {"PVZ", "particles/TrophySparkle.xml"}},
	{ParticleEffect::PARTICLE_PORTAL_CIRCLE, {"PVZ", "particles/PortalCircle.xml"}},
	{ParticleEffect::PARTICLE_PORTAL_SQUARE, {"PVZ", "particles/PortalSquare.xml"}},
	{ParticleEffect::PARTICLE_POTTED_PLANT_GLOW, {"PVZ", "particles/PottedPlantGlow.xml"}},
	{ParticleEffect::PARTICLE_POTTED_WATER_PLANT_GLOW, {"PVZ", "particles/PottedWaterPlantGlow.xml"}},
	{ParticleEffect::PARTICLE_POTTED_ZEN_GLOW, {"PVZ", "particles/PottedZenGlow.xml"}},
	{ParticleEffect::PARTICLE_MIND_CONTROL, {"PVZ", "particles/MindControl.xml"}},
	{ParticleEffect::PARTICLE_VASE_SHATTER, {"PVZ", "particles/VaseShatter.xml"}},
	{ParticleEffect::PARTICLE_VASE_SHATTER_LEAF, {"PVZ", "particles/VaseShatterLeaf.xml"}},
	{ParticleEffect::PARTICLE_VASE_SHATTER_ZOMBIE, {"PVZ", "particles/VaseShatterZombie.xml"}},
	{ParticleEffect::PARTICLE_AWARD_PICKUP_ARROW, {"PVZ", "particles/AwardPickupArrow.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_SEAWEED, {"PVZ", "particles/Zombie_seaweed.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_MUSTACHE, {"PVZ", "particles/ZombieMustache.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_SUNGLASS, {"PVZ", "particles/ZombieFutureGlasses.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_PINATA, {"PVZ", "particles/Pinata.xml"}},
	{ParticleEffect::PARTICLE_DUST_SQUASH, {"PVZ", "particles/Dust_Squash.xml"}},
	{ParticleEffect::PARTICLE_DUST_FOOT, {"PVZ", "particles/Dust_Foot.xml"}},
	{ParticleEffect::PARTICLE_ZOMBIE_DAISIES, {"PVZ", "particles/Daisy.xml"}},
	{ParticleEffect::PARTICLE_CREDIT_STROBE, {"PVZ", "particles/Credits_Strobe.xml"}},
	{ParticleEffect::PARTICLE_CREDITS_RAYSWIPE, {"PVZ", "particles/Credits_RaysWipe.xml"}},
	{ParticleEffect::PARTICLE_CREDITS_ZOMBIEHEADWIPE, {"PVZ", "particles/Credits_ZombieHeadWipe.xml"}},
	{ParticleEffect::PARTICLE_STARBURST, {"PVZ", "particles/Starburst.xml"}},
	{ParticleEffect::PARTICLE_CREDITS_FOG, {"PVZ", "particles/Credits_fog.xml"}},
	{ParticleEffect::PARTICLE_PERSENT_PICK_UP_ARROW, {"PVZ", "particles/UpsellArrow.xml"}},
};
