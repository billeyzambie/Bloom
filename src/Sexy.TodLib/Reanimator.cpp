...
ReanimationParams gLawnReanimationArray[(int)ReanimationType::NUM_REANIMS] = {
	{ReanimationType::REANIM_LOADBAR_SPROUT, {"PVZ", "reanim/LoadBar_sprout.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_LOADBAR_ZOMBIEHEAD, {"PVZ", "reanim/LoadBar_Zombiehead.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_SODROLL, {"PVZ", "reanim/SodRoll.reanim"}, 0},
	{ReanimationType::REANIM_FINAL_WAVE, {"PVZ", "reanim/FinalWave.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_PEASHOOTER, {"PVZ", "reanim/PeaShooterSingle.reanim"}, 0},
	{ReanimationType::REANIM_WALLNUT, {"PVZ", "reanim/Wallnut.reanim"}, 0},
	{ReanimationType::REANIM_LILYPAD, {"PVZ", "reanim/Lilypad.reanim"}, 0},
	{ReanimationType::REANIM_SUNFLOWER, {"PVZ", "reanim/SunFlower.reanim"}, 0},
	{ReanimationType::REANIM_LAWNMOWER, {"PVZ", "reanim/LawnMower.reanim"}, 0},
	{ReanimationType::REANIM_READYSETPLANT, {"PVZ", "reanim/StartReadySetPlant.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CHERRYBOMB, {"PVZ", "reanim/CherryBomb.reanim"}, 0},
	{ReanimationType::REANIM_SQUASH, {"PVZ", "reanim/Squash.reanim"}, 0},
	{ReanimationType::REANIM_DOOMSHROOM, {"PVZ", "reanim/DoomShroom.reanim"}, 0},
	{ReanimationType::REANIM_SNOWPEA, {"PVZ", "reanim/SnowPea.reanim"}, 0},
	{ReanimationType::REANIM_REPEATER, {"PVZ", "reanim/PeaShooter.reanim"}, 0},
	{ReanimationType::REANIM_SUNSHROOM, {"PVZ", "reanim/SunShroom.reanim"}, 0},
	{ReanimationType::REANIM_TALLNUT, {"PVZ", "reanim/Tallnut.reanim"}, 0},
	{ReanimationType::REANIM_FUMESHROOM, {"PVZ", "reanim/Fumeshroom.reanim"}, 0},
	{ReanimationType::REANIM_PUFFSHROOM, {"PVZ", "reanim/Puffshroom.reanim"}, 0},
	{ReanimationType::REANIM_HYPNOSHROOM, {"PVZ", "reanim/Hypnoshroom.reanim"}, 0},
	{ReanimationType::REANIM_CHOMPER, {"PVZ", "reanim/Chomper.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE, {"PVZ", "reanim/Zombie.reanim"}, 0},
	{ReanimationType::REANIM_SUN, {"PVZ", "reanim/Sun.reanim"}, 0},
	{ReanimationType::REANIM_POTATOMINE, {"PVZ", "reanim/PotatoMine.reanim"}, 0},
	{ReanimationType::REANIM_SPIKEWEED, {"PVZ", "reanim/Caltrop.reanim"}, 0},
	{ReanimationType::REANIM_SPIKEROCK, {"PVZ", "reanim/SpikeRock.reanim"}, 0},
	{ReanimationType::REANIM_THREEPEATER, {"PVZ", "reanim/ThreePeater.reanim"}, 0},
	{ReanimationType::REANIM_MARIGOLD, {"PVZ", "reanim/Marigold.reanim"}, 0},
	{ReanimationType::REANIM_ICESHROOM, {"PVZ", "reanim/IceShroom.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_FOOTBALL, {"PVZ", "reanim/Zombie_football.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_NEWSPAPER, {"PVZ", "reanim/Zombie_paper.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_ZAMBONI, {"PVZ", "reanim/Zombie_zamboni.reanim"}, 0},
	{ReanimationType::REANIM_SPLASH, {"PVZ", "reanim/splash.reanim"}, 0},
	{ReanimationType::REANIM_JALAPENO, {"PVZ", "reanim/Jalapeno.reanim"}, 0},
	{ReanimationType::REANIM_JALAPENO_FIRE, {"PVZ", "reanim/fire.reanim"}, 0},
	{ReanimationType::REANIM_COIN_SILVER, {"PVZ", "reanim/Coin_silver.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_CHARRED, {"PVZ", "reanim/Zombie_charred.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_CHARRED_IMP, {"PVZ", "reanim/Zombie_charred_imp.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_CHARRED_DIGGER, {"PVZ", "reanim/Zombie_charred_digger.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_CHARRED_ZAMBONI, {"PVZ", "reanim/Zombie_charred_zamboni.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_CHARRED_CATAPULT, {"PVZ", "reanim/Zombie_charred_catapult.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_CHARRED_GARGANTUAR, {"PVZ", "reanim/Zombie_charred_gargantuar.reanim"}, 0},
	{ReanimationType::REANIM_SCRAREYSHROOM, {"PVZ", "reanim/ScaredyShroom.reanim"}, 0},
	{ReanimationType::REANIM_PUMPKIN, {"PVZ", "reanim/Pumpkin.reanim"}, 0},
	{ReanimationType::REANIM_PLANTERN, {"PVZ", "reanim/Plantern.reanim"}, 0},
	{ReanimationType::REANIM_TORCHWOOD, {"PVZ", "reanim/Torchwood.reanim"}, 0},
	{ReanimationType::REANIM_SPLITPEA, {"PVZ", "reanim/SplitPea.reanim"}, 0},
	{ReanimationType::REANIM_SEASHROOM, {"PVZ", "reanim/SeaShroom.reanim"}, 0},
	{ReanimationType::REANIM_BLOVER, {"PVZ", "reanim/Blover.reanim"}, 0},
	{ReanimationType::REANIM_FLOWER_POT, {"PVZ", "reanim/Pot.reanim"}, 0},
	{ReanimationType::REANIM_CACTUS, {"PVZ", "reanim/Cactus.reanim"}, 0},
	{ReanimationType::REANIM_DANCER, {"PVZ", "reanim/Zombie_disco.reanim"}, 0},
	{ReanimationType::REANIM_TANGLEKELP, {"PVZ", "reanim/Tanglekelp.reanim"}, 0},
	{ReanimationType::REANIM_STARFRUIT, {"PVZ", "reanim/Starfruit.reanim"}, 0},
	{ReanimationType::REANIM_POLEVAULTER, {"PVZ", "reanim/Zombie_polevaulter.reanim"}, 0},
	{ReanimationType::REANIM_BALLOON, {"PVZ", "reanim/Zombie_balloon.reanim"}, 0},
	{ReanimationType::REANIM_GARGANTUAR, {"PVZ", "reanim/Zombie_gargantuar.reanim"}, 0},
	{ReanimationType::REANIM_IMP, {"PVZ", "reanim/Zombie_imp.reanim"}, 0},
	{ReanimationType::REANIM_DIGGER, {"PVZ", "reanim/Zombie_digger.reanim"}, 0},
	{ReanimationType::REANIM_DIGGER_DIRT, {"PVZ", "reanim/Digger_rising_dirt.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_DOLPHINRIDER, {"PVZ", "reanim/Zombie_dolphinrider.reanim"}, 0},
	{ReanimationType::REANIM_POGO, {"PVZ", "reanim/Zombie_pogo.reanim"}, 0},
	{ReanimationType::REANIM_BACKUP_DANCER, {"PVZ", "reanim/Zombie_backup.reanim"}, 0},
	{ReanimationType::REANIM_BOBSLED, {"PVZ", "reanim/Zombie_bobsled.reanim"}, 0},
	{ReanimationType::REANIM_JACKINTHEBOX, {"PVZ", "reanim/Zombie_jackbox.reanim"}, 0},
	{ReanimationType::REANIM_SNORKEL, {"PVZ", "reanim/Zombie_snorkle.reanim"}, 0},
	{ReanimationType::REANIM_BUNGEE, {"PVZ", "reanim/Zombie_bungi.reanim"}, 0},
	{ReanimationType::REANIM_CATAPULT, {"PVZ", "reanim/Zombie_catapult.reanim"}, 0},
	{ReanimationType::REANIM_LADDER, {"PVZ", "reanim/Zombie_ladder.reanim"}, 0},
	{ReanimationType::REANIM_PUFF, {"PVZ", "reanim/Puff.reanim"}, 0},
	{ReanimationType::REANIM_SLEEPING, {"PVZ", "reanim/Z.reanim"}, 0},
	{ReanimationType::REANIM_GRAVE_BUSTER, {"PVZ", "reanim/Gravebuster.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIES_WON, {"PVZ", "reanim/ZombiesWon.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_MAGNETSHROOM, {"PVZ", "reanim/Magnetshroom.reanim"}, 0},
	{ReanimationType::REANIM_BOSS, {"PVZ", "reanim/Zombie_boss.reanim"}, 0},
	{ReanimationType::REANIM_CABBAGEPULT, {"PVZ", "reanim/Cabbagepult.reanim"}, 0},
	{ReanimationType::REANIM_KERNELPULT, {"PVZ", "reanim/Cornpult.reanim"}, 0},
	{ReanimationType::REANIM_MELONPULT, {"PVZ", "reanim/Melonpult.reanim"}, 0},
	{ReanimationType::REANIM_COFFEEBEAN, {"PVZ", "reanim/Coffeebean.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_UMBRELLALEAF, {"PVZ", "reanim/Umbrellaleaf.reanim"}, 0},
	{ReanimationType::REANIM_GATLINGPEA, {"PVZ", "reanim/GatlingPea.reanim"}, 0},
	{ReanimationType::REANIM_CATTAIL, {"PVZ", "reanim/Cattail.reanim"}, 0},
	{ReanimationType::REANIM_GLOOMSHROOM, {"PVZ", "reanim/GloomShroom.reanim"}, 0},
	{ReanimationType::REANIM_BOSS_ICEBALL, {"PVZ", "reanim/Zombie_boss_iceball.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_BOSS_FIREBALL, {"PVZ", "reanim/Zombie_boss_fireball.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_COBCANNON, {"PVZ", "reanim/CobCannon.reanim"}, 0},
	{ReanimationType::REANIM_GARLIC, {"PVZ", "reanim/Garlic.reanim"}, 0},
	{ReanimationType::REANIM_GOLD_MAGNET, {"PVZ", "reanim/GoldMagnet.reanim"}, 0},
	{ReanimationType::REANIM_WINTER_MELON, {"PVZ", "reanim/WinterMelon.reanim"}, 0},
	{ReanimationType::REANIM_TWIN_SUNFLOWER, {"PVZ", "reanim/TwinSunflower.reanim"}, 0},
	{ReanimationType::REANIM_POOL_CLEANER, {"PVZ", "reanim/PoolCleaner.reanim"}, 0},
	{ReanimationType::REANIM_ROOF_CLEANER, {"PVZ", "reanim/RoofCleaner.reanim"}, 0},
	{ReanimationType::REANIM_FIRE_PEA, {"PVZ", "reanim/FirePea.reanim"}, 0},
	{ReanimationType::REANIM_IMITATER, {"PVZ", "reanim/Imitater.reanim"}, 0},
	{ReanimationType::REANIM_YETI, {"PVZ", "reanim/Zombie_yeti.reanim"}, 0},
	{ReanimationType::REANIM_BOSS_DRIVER, {"PVZ", "reanim/Zombie_Boss_driver.reanim"}, 0},
	{ReanimationType::REANIM_LAWN_MOWERED_ZOMBIE, {"PVZ", "reanim/LawnMoweredZombie.reanim"}, 0},
	{ReanimationType::REANIM_CRAZY_DAVE, {"PVZ", "reanim/CrazyDave.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_TEXT_FADE_ON, {"PVZ", "reanim/TextFadeOn.reanim"}, 0},
	{ReanimationType::REANIM_HAMMER, {"PVZ", "reanim/Hammer.reanim"}, 0},
	{ReanimationType::REANIM_SLOT_MACHINE_HANDLE, {"PVZ", "reanim/SlotMachine.reanim"}, 0},
	{ReanimationType::REANIM_CREDITS_FOOTBALL, {"PVZ", "reanim/Credits_Football.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_JACKBOX, {"PVZ", "reanim/Credits_Jackbox.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_SELECTOR_SCREEN, {"PVZ", "reanim/SelectorScreen.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS) | GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
	{ReanimationType::REANIM_PORTAL_CIRCLE, {"PVZ", "reanim/Portal_Circle.reanim"}, 0},
	{ReanimationType::REANIM_PORTAL_SQUARE, {"PVZ", "reanim/Portal_Square.reanim"}, 0},
	{ReanimationType::REANIM_ZENGARDEN_SPROUT, {"PVZ", "reanim/ZenGarden_sprout.reanim"}, 0},
	{ReanimationType::REANIM_ZENGARDEN_WATERINGCAN, {"PVZ", "reanim/ZenGarden_wateringcan.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_ZENGARDEN_FERTILIZER, {"PVZ", "reanim/ZenGarden_fertilizer.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_ZENGARDEN_BUGSPRAY, {"PVZ", "reanim/ZenGarden_bugspray.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_ZENGARDEN_PHONOGRAPH, {"PVZ", "reanim/ZenGarden_phonograph.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_DIAMOND, {"PVZ", "reanim/Diamond.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_HAND, {"PVZ", "reanim/Zombie_hand.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_STINKY, {"PVZ", "reanim/Stinky.reanim"}, 0},
	{ReanimationType::REANIM_RAKE, {"PVZ", "reanim/Rake.reanim"}, 0},
	{ReanimationType::REANIM_RAIN_CIRCLE, {"PVZ", "reanim/Rain_circle.reanim"}, 0},
	{ReanimationType::REANIM_RAIN_SPLASH, {"PVZ", "reanim/Rain_splash.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBIE_SURPRISE, {"PVZ", "reanim/Zombie_surprise.reanim"}, 0},
	{ReanimationType::REANIM_COIN_GOLD, {"PVZ", "reanim/Coin_gold.reanim"}, 0},
	{ReanimationType::REANIM_TREEOFWISDOM, {"PVZ", "reanim/TreeOfWisdom.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_TREEOFWISDOM_CLOUDS, {"PVZ", "reanim/TreeOfWisdomClouds.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_TREEOFWISDOM_TREEFOOD, {"PVZ", "reanim/TreeFood.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_MAIN, {"PVZ", "reanim/Credits_Main.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS) | GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
	{ReanimationType::REANIM_CREDITS_MAIN2, {"PVZ", "reanim/Credits_Main2.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS) | GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
	{ReanimationType::REANIM_CREDITS_MAIN3, {"PVZ", "reanim/Credits_Main3.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS) | GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
	{ReanimationType::REANIM_ZOMBIE_CREDITS_DANCE, {"PVZ", "reanim/Zombie_credits_dance.reanim"}, 0},
	{ReanimationType::REANIM_CREDITS_STAGE, {"PVZ", "reanim/Credits_stage.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_BIGBRAIN, {"PVZ", "reanim/Credits_BigBrain.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_FLOWER_PETALS, {"PVZ", "reanim/Credits_Flower_petals.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_INFANTRY, {"PVZ", "reanim/Credits_Infantry.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_THROAT, {"PVZ", "reanim/Credits_Throat.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_CRAZYDAVE, {"PVZ", "reanim/Credits_CrazyDave.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_BOSSDANCE, {"PVZ", "reanim/Credits_Bossdance.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_ZOMBIE_CREDITS_SCREEN_DOOR, {"PVZ", "reanim/Zombie_Credits_Screendoor.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_ZOMBIE_CREDITS_CONEHEAD, {"PVZ", "reanim/Zombie_Credits_Conehead.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_ZOMBIEARMY1, {"PVZ", "reanim/Credits_ZombieArmy1.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_ZOMBIEARMY2, {"PVZ", "reanim/Credits_ZombieArmy2.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_TOMBSTONES, {"PVZ", "reanim/Credits_Tombstones.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_SOLARPOWER, {"PVZ", "reanim/Credits_SolarPower.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_ANYHOUR, {"PVZ", "reanim/Credits_Anyhour.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS) | GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
	{ReanimationType::REANIM_CREDITS_WEARETHEUNDEAD, {"PVZ", "reanim/Credits_WeAreTheUndead.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_CREDITS_DISCOLIGHTS, {"PVZ", "reanim/Credits_DiscoLights.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
	{ReanimationType::REANIM_FLAG, {"PVZ", "reanim/Zombie_FlagPole.reanim"}, 0},
	{ReanimationType::REANIM_ZOMBATAR_HEAD,	 {"PVZ", "reanim/zombatar_zombie_head.reanim"}, GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
};
...
void ReanimationCreateAtlas(ReanimatorDefinition *theDefinition, ReanimationType theReanimationType)
{
	...
	TodHesitationTrace("atlas '%s'", aParam.mReanimFileName.CStr());
	int aDuration = std::max(aTimer.GetDuration(), 0.0);
	if (aDuration > 20 && theReanimationType != ReanimationType::REANIM_NONE)
		TodTraceAndLog("[TodLib] - LOADING:Long atlas '%s' %d ms on %s", aParam.mReanimFileName.CStr(), aDuration,
...
void ReanimatorEnsureDefinitionLoaded(ReanimationType theReanimType, bool theIsPreloading)
{
	...
	else
	{
		if (gAppHasUsedCheatKeys())
			TodTraceAndLog("[TodLib] - Cheater failed to preload '%s' on %s", aReanimParams->mReanimFileName.CStr(), gGetCurrentLevelName().c_str());
		else
			TodTraceAndLog("[TodLib] - Non-cheater failed to preload '%s' on %s", aReanimParams->mReanimFileName.CStr(), gGetCurrentLevelName().c_str());
	} 

	PerfTimer aTimer;
	aTimer.Start();
	TodHesitationBracket aHesitation("Load Reanim '%s'", aReanimParams->mReanimFileName.CStr());
	if (!ReanimationLoadDefinition(aReanimParams->mReanimFileName, aReanimDef))
	{
		char aBuf[1024];
#ifdef _WIN32
		sprintf_s<1024U>(aBuf, "Failed to load reanim '%s'", aReanimParams->mReanimFileName.CStr());
#else
		snprintf(aBuf, 1024, "Failed to load reanim '%s'", aReanimParams->mReanimFileName.CStr());
#endif
	...
	if (aDuration > 100) //（仅内测版）创建时间过长的报告
		TodTraceAndLog("[TodLib] - LOADING:Long reanim '%s' %d ms on %s",
					   aReanimParams->mReanimFileName.CStr(),
					   aDuration,
					   gGetCurrentLevelName().c_str());
}
...
void Reanimation::UpdateAttacherTrack(int theTrackIndex)
{
	...
	{
		//TODO: When custom reanims come out remove the PVZ assumption
		std::string aReanimFileName = StrFormat("PVZ/reanim/%s.reanim", aAttacherInfo.mReanimName.c_str());
		for (int i = 0; i < gReanimationParamArraySize; i++)
		{
			ReanimationParams *aParams = &gReanimationParamArray[i];
			if (stricmp(aReanimFileName.c_str(), aParams->mReanimFileName.CStr()) == 0)
			{
